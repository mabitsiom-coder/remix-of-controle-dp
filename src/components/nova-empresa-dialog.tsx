...
import { Plus, Building2, UserCheck, ShieldAlert, FileText, CheckCircle2, Settings, Search, Wand2, Trash2, UserPlus } from "lucide-react";
            ...
            <TabsContent value="dados" className="mt-4 space-y-4">
              ...
              {formData.tipo === "domestico-pf" && (
                <div className="mt-2 rounded-lg border border-blue-200 bg-blue-50/60 dark:border-blue-800 dark:bg-blue-950/30 p-4 space-y-3">
                  ...
                  {/* Lista de funcionários já adicionados */}
